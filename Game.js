...
insur.Game.prototype = {
	...
	this.coin = insur.game.add.sprite(600, 300, 'coins');
        ...
        //puntuacion
        this.puntuacion = insur.game.add.text(30, 30, 'puntuacion: 0',{ font: '18px Arial', fill: '#0000FF' });
    ...
    update: function() {
        ...
        insur.game.physics.arcade.collide(this.platforms, this.coin);
        insur.game.physics.arcade.collide(this.floors, this.coin);
