define(function(require, exports, module) {
    ...
    Menu.prototype = {
        ...
        create: function () {
            ...
            this.loadingLabel = this.game.add.text(this.game.world.centerX, 150, 'Infinite Survival',{ font: '100px VT323',  fill: '#000000' });
            ...
            this.startLabel = this.game.add.text(this.game.world.centerX-10, 540, 'Start',{ font: '50px VT323',  fill: '#000000' });
