define(function(require, exports, module) {
    ...
    GameOver.prototype = {
        create: function () {
            ...
            this.title = this.game.add.text(0, this.menu.y+14, "Menu", { font: '50px IMFellEnglishSC',  fill: '#000000' });
            ...
            this.buttons = new ButtonGroup(this.game, 480, 400, "center", "horizontal");
            ...
            this.buttons = new ButtonGroup(this.game, 480, 480, "center", "horizontal");
